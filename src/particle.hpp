...
namespace proj {
    ...
    class Particle {
        ...
        public:
            ...
            pair<double, unsigned> proposeCoalescence(unsigned seed, unsigned step, unsigned locus, unsigned pindex, bool compute_partial, bool make_permanent);
            void advance(unsigned step, unsigned locus, unsigned pindex, bool compute_partial, bool make_permanent);
            double priorPrior(unsigned step, unsigned locus, unsigned pindex, double total_rate, bool compute_partial);
#else
