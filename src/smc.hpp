...
namespace proj {
    ...
    class SMC : public ParallelPolicyNone<SMC> {
        ...
        public:
            ...
            double filterParticles(unsigned step, unsigned locus, list<Particle> & particle_list, vector<double> & log_weights, vector<unsigned> & counts, vector<unsigned> & rnseeds);
#else
